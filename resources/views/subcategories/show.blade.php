            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="  p-3 ml-10 mr-10  mb-10" x-data="modal()">
                    <div class="bg-gray-100 p-3 border rounded-md">
                        <div class="bg-white p-3 m-3 rounded-md border-2 w-1/3">Description : {{ $subcategory->description }}</div>

                        <div>
                                <a href="{{route('subcategories.edit',$subcategory)}}" class="p-3 border rounded-md border-green-400 hover:bg-green-400
                        ...
                        <div x-show="modal == true"
                            ...
                            rounded-md border-2 p-3 ">
                                <div class="m-3">
                                    <div>
                                        You are trying to cancel the current Subcategory.

                                    </div>
                                    <div>
                                        By clicking "DELETE" , Subcategory will be permanently deleted. Are you sure?
                                ...
                                <div class=" flex grid grid-cols-2 items-center ">
                                    ...
                                    <div class="col-span-1 items-center ">
                                        <form method="POST" class="mt-2">
                                            ...
                                            bg-green-200 text-sm" > Delete Subcategory
                                            </button>
                                        </form>
